...
- **홈(S01)** 은 준돈·받은돈 **상단 탭 2개**로 나뉜다. 기본은 준돈이고 둘 다 행사 날짜 최신순 내림차순이다. 각 탭은 기록 목록이며 한 행에 사람·행사·날짜·금액이 보인다. **행의 사람 이름을 누르면 사람 원장(S04)으로 간다.** 사람 탭을 없앤 대신 이곳이 사람별 수지로 가는 주 진입로다.
...
| S11 | 통계 | 기간별 집계 | 연도 세그먼트(전체 + 기록이 있는 연도), 준돈·받은돈 총계와 차액, 종류별·그룹별 막대, 사람별 상위(전체 기간) | 하단 탭 | 사람 행 탭 시 S04 |
