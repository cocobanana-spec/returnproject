...
| 12 | 로그인 수단 | **Apple + Google + Kakao, 첫 출시부터** (추천안 "Kakao 후속"과 다름) | 09-16 |
...
| 7 | 화환·선물의 금액을 수지 합계에 포함할까요 | **금액을 적었으면 포함, 안 적었으면 미확정으로 제외** | 합계 정의가 바뀌므로 통계 화면 문구까지 같이 본다 |
...
| 10 | "참석했지만 부조 안 함"을 기록하고 싶습니까 | **필드는 두되 "더 보기" 안에 숨김** | 화면 배치만 바꾸면 된다. 가장 싸다 |
